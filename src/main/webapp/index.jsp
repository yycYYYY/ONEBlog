...
<html>
	...
	<link rel="stylesheet" href="<%=request.getContextPath()%>/css/w3blog.css">
 	<link rel="stylesheet"
		...
		<div class="w3-row">
			...
			<div class="w3-col l4">
				...
				<div class="w3-card w3-margin w3-margin-top">
					<img src="<%=request.getContextPath()%>/images/me.jpg" style="width:100%">
					<div class="w3-container w3-white">
						<h4>
							<b>My Name</b> 小马
						</h4>
						<p> Just me, 一个Java初学者，带着常年每分钟51下跳动的心脏，缓慢的保持着对技术的热爱。
						</p>
					</div>
				</div>
				<hr>
				...
				<div class="w3-card w3-margin">
					...
					<ul class="w3-ul w3-hoverable w3-white">
						...
						word-break:break-all;text-overflow:ellipsis;overflow:hidden;"><img src="<%=request.getContextPath()%>/images/workshop.jpg"
							alt="Image" class="w3-left w3-margin-right" style="width:50px">
							</li>
						<li class="w3-padding-16" id="li2" style="word-wrap:break-word;
						word-break:break-all;text-overflow:ellipsis;overflow:hidden;"><img src="<%=request.getContextPath()%>/images/gondol.jpg"
							alt="Image" class="w3-left w3-margin-right" style="width:50px">
							</li>
						<li class="w3-padding-16" id="li3" style="word-wrap:break-word;
						word-break:break-all;text-overflow:ellipsis;overflow:hidden;"><img src="<%=request.getContextPath()%>/images/skies.jpg"
							alt="Image" class="w3-left w3-margin-right" style="width:50px">
							</li>
						...
						word-break:break-all;text-overflow:ellipsis;overflow:hidden;"><img
                                src="<%=request.getContextPath()%>/images/rock.jpg" alt="Image" class="w3-left w3-margin-right"
                                style="width:50px"></li>
					</ul>
				</div>
				<hr>
				...
				// 清空分页
					...
					$.each(articles, function(index, item) {
                        ...
                        if(index % 5 == 0) {
							...
							img = $("<img></img>").attr("src", "images/ss3.jpg").attr("alt", "star8").css("width","100%");
						} else if(index % 5 == 3) {
							img = $("<img></img>").attr("src", "images/ss5.jpg").attr("alt", "starwars").css("width","100%");
						} else if(index % 5 == 4) {
